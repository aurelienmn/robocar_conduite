...
class ControllerSettings:
    ...
    centerline_gain: float = 1.05
    heading_gain: float = 0.75
    centerline_blend: float = 0.95
    navigation_margin_rays: int = 2
    boundary_avoidance_distance_px: float = 260.0
    boundary_avoidance_gain: float = 1.25
    boundary_avoidance_max_steering: float = 0.75
    turn_anticipation_distance_px: float = 210.0
    turn_anticipation_steering: float = 0.68
    turn_anticipation_throttle_scale: float = 0.58
    boundary_guard_distance_px: float = 125.0
    boundary_guard_steering: float = 0.78
    recovery_throttle: float = 0.038
